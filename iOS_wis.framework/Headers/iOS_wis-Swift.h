...
+ (void)saveClickCookieWithParameters:(NSDictionary<NSString *, id> * _Nonnull)parameters SWIFT_DEPRECATED_OBJC("Swift method 'Webinstats.saveClickCookie(parameters:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
