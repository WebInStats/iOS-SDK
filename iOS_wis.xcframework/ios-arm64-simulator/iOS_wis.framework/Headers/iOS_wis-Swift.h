...
#ifndef IOS_WIS_SWIFT_H
#define IOS_WIS_SWIFT_H
...
+ (void)handleDeeplinkWithCompletion:(void (^ _Nonnull)(NSString * _Nonnull))completion;
...
- (void)setPayloadTitleWithTitle:(NSString * _Nonnull)title;
- (void)setPayloadBodyWithBody:(NSString * _Nonnull)body;
- (void)setPayloadIconWithIcon:(NSString * _Nonnull)icon;
- (void)setPayloadSoundWithSound:(NSString * _Nonnull)sound;
- (void)setPayloadVibrateWithVibrate:(NSString * _Nonnull)vibrate;
